...
Our goal is to offer efficient, cost-effective and the best transport solutions to our customers, principals and our associates and constantly improve the effectiveness of the quality management system.
 ...
 <p className="mb-4 text-gray-700">
Continuous investments in Human Resources and IT infrastructure enables us to deliver consistent professional quality services and solutions, which will sustain us in an ever changing dynamic market.</p>
          </div>
    ...
    <div className="min-h-screen bg-white pt-20">
      <div className="container mx-auto px-9 py-8 flex gap-7">
        ...
        <main className="flex-1 min-w-0 font-roboto font-normal text-[17px] leading-[120%] tracking-[0] align-middle weight-400">
          <div className="bg-white rounded-lg p-6">{getCurrentContent()}</div>
        </main>
      </div>
    </div>
  );
