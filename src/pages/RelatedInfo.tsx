...
const RelatedInfo = () => {
  // Information sections about Bahrain and shipping industry
  const infoSections = [
    {
      id: 1,
      ...
      images: [
        '/images/bahrain-causeway.jpg',
        '/images/bahrain-port.jpg',
        '/images/bahrain-logistics.jpg',
        '/images/bahrain-wtc.jpg'
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      linkText: 'For more information',
      images: ['/images/apm-terminals.jpg']
    },
    {
      id: 4,
    ...
    },
    {
      ...
      linkText: 'For more information',
      images: ['/images/ports-maritime.jpg']
    }
  ];

  return (
    <div className="container mx-auto px-4 py-12 pt-[90px]">
      <h1 className="text-3xl font-bold mb-2">Related Information</h1>
        ...
        {infoSections.map((section) => (
          <div key={section.id} className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            {section.images && section.images.length > 0 && (
              <div className={`grid grid-cols-1 ${section.images.length > 1 ? 'md:grid-cols-2' : ''} ${section.images.length >= 4 ? 'lg:grid-cols-4' : ''} gap-4 p-6 pt-0`}>
